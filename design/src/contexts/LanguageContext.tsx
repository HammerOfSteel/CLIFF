...
const translations = {
  sv: {
    ...
    'profile.streak': '-dagars streak!',
    'profile.storiesRead': 'Berättelser lästa',
    'profile.totalReadTime': 'Total lästid',
    'profile.favoriteGenre': 'Favoritgenre',
    'profile.unlocked': 'upplåsta',
    'profile.episodes': 'episoder',
    'profile.ongoing': 'Pågående',
    'profile.completed': 'Avslutad',
    'profile.reads': 'läsningar',
    'profile.noStories': 'Du har inte skapat några berättelser än',
    'profile.createNew': '+ Skapa ny berättelse',
    ...
    'achievements.firstStory': 'Första berättelsen',
    'achievements.sevenDayStreak': '7-dagars streak',
    'achievements.published': 'Publicerad',
    'achievements.hundredReads': '100 läsningar',
    'achievements.tenStories': '10 berättelser',
    'achievements.thirtyDayStreak': '30-dagars streak',
  },
  en: {
    // Navigation
    ...
    'profile.totalReadTime': 'Total reading time',
    ...
    'profile.reads': 'reads',
    'profile.noStories': 'You haven\'t created any stories yet',
    'profile.createNew': '+ Create new story',
    ...
    'achievements.firstStory': 'First story',
    'achievements.sevenDayStreak': '7-day streak',
    'achievements.published': 'Published',
    'achievements.hundredReads': '100 reads',
    'achievements.tenStories': '10 stories',
    'achievements.thirtyDayStreak': '30-day streak',
  },
};
